...
enum opt_code
{
  ...
  OPT_mbionic = 949,                         /* -mbionic */
  OPT_mbranch_cost_ = 950,                   /* -mbranch-cost= */
  OPT_mbranch_likely = 951,                  /* -mbranch-likely */
  OPT_mcheck_zero_division = 952,            /* -mcheck-zero-division */
  OPT_mcode_readable_ = 953,                 /* -mcode-readable= */
  OPT_mdebug = 954,                          /* -mdebug */
  OPT_mdebugd = 955,                         /* -mdebugd */
  OPT_mdivide_breaks = 956,                  /* -mdivide-breaks */
  OPT_mdivide_traps = 957,                   /* -mdivide-traps */
  OPT_mdmx = 958,                            /* -mdmx */
  OPT_mdouble_float = 959,                   /* -mdouble-float */
  OPT_mdsp = 960,                            /* -mdsp */
  OPT_mdspr2 = 961,                          /* -mdspr2 */
  OPT_meb = 962,                             /* -meb */
  OPT_mel = 963,                             /* -mel */
  OPT_membedded_data = 964,                  /* -membedded-data */
  OPT_mexplicit_relocs = 965,                /* -mexplicit-relocs */
  OPT_mextern_sdata = 966,                   /* -mextern-sdata */
  OPT_mfix_r10000 = 967,                     /* -mfix-r10000 */
  OPT_mfix_r4000 = 968,                      /* -mfix-r4000 */
  OPT_mfix_r4400 = 969,                      /* -mfix-r4400 */
  OPT_mfix_sb1 = 970,                        /* -mfix-sb1 */
  OPT_mfix_vr4120 = 971,                     /* -mfix-vr4120 */
  OPT_mfix_vr4130 = 972,                     /* -mfix-vr4130 */
  OPT_mfix4300 = 973,                        /* -mfix4300 */
  OPT_mflip_mips16 = 974,                    /* -mflip-mips16 */
  OPT_mflush_func_ = 975,                    /* -mflush-func= */
  OPT_mfp_exceptions = 976,                  /* -mfp-exceptions */
  OPT_mfp32 = 977,                           /* -mfp32 */
  OPT_mfp64 = 978,                           /* -mfp64 */
  OPT_mfused_madd = 979,                     /* -mfused-madd */
  OPT_mglibc = 980,                          /* -mglibc */
  OPT_mgp32 = 981,                           /* -mgp32 */
  OPT_mgp64 = 982,                           /* -mgp64 */
  OPT_mgpopt = 983,                          /* -mgpopt */
  OPT_mhard_float = 984,                     /* -mhard-float */
  OPT_minterlink_mips16 = 985,               /* -minterlink-mips16 */
  OPT_mips = 986,                            /* -mips */
  OPT_mips16 = 987,                          /* -mips16 */
  OPT_mips3d = 988,                          /* -mips3d */
  OPT_mllsc = 989,                           /* -mllsc */
  OPT_mlocal_sdata = 990,                    /* -mlocal-sdata */
  OPT_mlong_calls = 991,                     /* -mlong-calls */
  OPT_mlong32 = 992,                         /* -mlong32 */
  OPT_mlong64 = 993,                         /* -mlong64 */
  OPT_mmcount_ra_address = 994,              /* -mmcount-ra-address */
  OPT_mmemcpy = 995,                         /* -mmemcpy */
  OPT_mmips_tfile = 996,                     /* -mmips-tfile */
  OPT_mmt = 997,                             /* -mmt */
  OPT_mno_float = 998,                       /* -mno-float */
  OPT_mno_flush_func = 999,                  /* -mno-flush-func */
  OPT_mno_mdmx = 1000,                       /* -mno-mdmx */
  OPT_mno_mips16 = 1001,                     /* -mno-mips16 */
  OPT_mno_mips3d = 1002,                     /* -mno-mips3d */
  OPT_mpaired_single = 1003,                 /* -mpaired-single */
  OPT_mplt = 1004,                           /* -mplt */
  ...
  OPT_muclibc = 1015,                        /* -muclibc */
  OPT_muninit_const_in_rodata = 1016,        /* -muninit-const-in-rodata */
  OPT_mvr4130_align = 1017,                  /* -mvr4130-align */
  OPT_mxgot = 1018,                          /* -mxgot */
  OPT_n = 1019,                              /* -n */
  OPT_no_canonical_prefixes = 1020,          /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 1021,              /* -no-integrated-cpp */
  OPT_noasmopt = 1022,                       /* -noasmopt */
