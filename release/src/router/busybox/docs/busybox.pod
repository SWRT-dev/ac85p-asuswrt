...
Currently available applets include:
	...
	rmmod, route, sed, setconsole, sh, sleep, sort, start-stop-daemon,
	strings, swapoff, swapon, sync, syslogd, tail, tar, telnetd, test,
	top, touch, tr, traceroute, traceroute6, true, udhcpc, umount,
	uname, uniq, unzip, uptime, usleep, vconfig, vi, watch, wc, which,
	xargs, zcat, zcip
